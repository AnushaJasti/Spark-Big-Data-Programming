...
object ICP6 {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //Saving to File
    stationGraph.vertices.write.csv("C:\\Users\\thota\\IdeaProjects\\Spark_ICP_5\\Graphs2\\Vertices")
    stationGraph.edges.write.csv("C:\\Users\\thota\\IdeaProjects\\Spark_ICP_5\\Graphs2\\Edges")
