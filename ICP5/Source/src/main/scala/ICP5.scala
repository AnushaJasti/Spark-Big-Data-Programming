...
object ICP5 {
  def main(args: Array[String]) {
    ...
    stationGraph.vertices.write.csv("C:\\Users\\thota\\IdeaProjects\\Spark_ICP_5\\Graphs1\\Vertices")

    stationGraph.edges.write.csv("C:\\Users\\thota\\IdeaProjects\\Spark_ICP_5\\Graphs1\\Edges")
